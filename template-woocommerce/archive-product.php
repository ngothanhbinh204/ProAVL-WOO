...
<section class="page-banner-main banner-product rem:min-h-[400px] flex flex-col justify-between"
    setBackground="<?php echo $banner['url'] ? $banner['url'] : get_template_directory_uri().'/img/1.jpg'; ?>">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo get_term_link($child_cat); ?>"
                        class="item-category<?php echo ($cat->term_id == $child_cat->term_id) ? ' active' : ''; ?>">
                        <div class="icon">
                            <img class="lozad undefined"
                                data-src="<?php echo $image ? $image : get_template_directory_uri().'/img/13.svg'; ?>"
                                alt="<?php echo $child_cat->name; ?>" />
        ...
        <div class="row">
                    ...
                    <div class="wrap-form-style flex flex-col gap-base">
                        ...
                        <div class="wrap-list-packages">
                            ...
                            <div class="item-package"
                                ...
                                data-img="<?php echo esc_url($product_image); ?>"
                                data-product-id="<?php echo esc_attr($product_id); ?>"
                                data-price="<?php echo esc_attr($product->get_price()); ?>"
                                data-title="<?php echo esc_attr(get_the_title()); ?>">
                                <div class="content">
                                    <div class="icon"><img class="lozad undefined"
                                            data-src="<?php echo esc_url($product_image); ?>"
                                ...
                                <div class="quantity">
                                    ...
                                    <input type="text" value="0" class="package-quantity"
                                        data-product-id="<?php echo esc_attr($product_id); ?>">
            ...
            <div class="col-lg-4">
                <div class="product-box-delivery bg-white/60 rounded-4 lg:p-6 p-base mb-base">
                    <div class="title-24 border-b border-b-white mb-[15px] pb-[15px] lg:pb-6 lg:mb-6 font-bold">2. User
                        Information</div>
                        ...
                        <div class="item-input-info">
                            ...
                            <div>
                                ...
                                <span class="error-message"
                                    style="color: #e74c3c; font-size: 12px; display: none;"></span>
                            </div>
                        </div>
                        <div class="item-input-info">
                ...
                <div class="product-box-delivery bg-white/60 rounded-4 lg:p-6 p-base">
                    ...
                    <div
                        class="wrap-sum lg:py-6 lg:my-6 py-[15px] my-[15px] border-b border-t border-white flex items-center justify-between">
                        <p>Total:</p>
                        <p class="title-24 font-bold" id="topup-total-price">0$</p>
                    </div>
                    <div class="wrap-button flex flex-col gap-6">
                        <div class="btn btn-primary" id="topup-add-to-cart"> <span>ADD TO CART</span><i
                                class="fa-light fa-cart-shopping-fast text-xl"></i></div>
                        <div class="btn btn-primary style-black" id="topup-buy-now"><span
                                id="topup-buy-now-price">0$</span><span>|</span><span>BUY NOW</span></div>
                    </div>
                    <div class="accepttable">
                        <label for="accept">
                            <input type="checkbox" id="accept">
                            <p>By ticking, you have read and agree to our <a
                                    href="<?php echo get_permalink(get_page_by_path('terms-of-service')); ?>">Terms of
                                    Service,</a><a
                                    href="<?php echo get_permalink(get_page_by_path('refund-policy')); ?>">Refund and
                                    Exchange Policy </a>and <a
            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div
                            class="item-product-featured bg-white/60 flex flex-col p-5 rounded-4 backdrop-blur-md gap-5">
                            <a href="<?php the_permalink(); ?>"
                                class="img img-ratio ratio:pt-[440_820] rounded-4 zoom-img">
                                <img class="lozad undefined" data-src="<?php echo esc_url($product_image); ?>"
                                    alt="<?php echo esc_attr(get_the_title()); ?>" />
                            </a>
                            <div class="wrap-content flex justify-between items-end gap-5 flex-wrap">
                                <div class="flex flex-col">
                                    ...
                                    <?php if($cat_image): ?>
                                    <div class="logo mt-1">
                                        <img class="lozad undefined" data-src="<?php echo esc_url($cat_image); ?>"
                                            alt="<?php echo esc_attr($product_cats[0]->name); ?>" />
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<section class="section-product-list-sell section-py">
    <div class="container">
        ...
        <div class="flex flex-col lg:gap-5 gap-[15px] text-white mb-base">
            ...
            <p
                class="box-wrap border border-primary-1 bg-white/20 text-white p-4 py-2 rounded-4 rem:min-h-[80px] title-40 [&amp;_a]:underline break-words">
                    ...
                    <ul class="list-social flex flex-col gap-5">
                        ...
                        <li class="font-bold flex flex-col gap-2">
                            <div class="title-24 flex items-center gap-4">
                                <?php if($item['icon']): ?>
                                <img class="lozad undefined" data-src="<?php echo $item['icon']['url']; ?>"
                                    alt="<?php echo $item['icon']['alt']; ?>" />
                                <?php else: ?>
                                <img class="lozad undefined"
                                    data-src="<?php echo get_stylesheet_directory_uri(); ?>/img/16.svg" alt="" />
                                <?php endif; ?>
        ...
        <div class="wrap-form-filter wrap-form-style lg:mb-8 mb-[15px]">
            ...
            <div class="form-select">
                <form method="GET" action="">
                    <select name="filter-category-<?php echo $index+1; ?>" id="filter-category-<?php echo $index+1; ?>"
                        placeholder="<?php echo $child_cat->name; ?>" onchange="this.form.submit()">
                        <option value=""><?php echo $child_cat->name; ?></option>
                        <?php
                ...
                <form method="GET" action="">
                    <select name="orderby" onchange="this.form.submit()">
                        <option value="menu_order"
                            ...
                            <?php _e('Recommend', 'canhcamtheme'); ?></option>
                        <option value="popularity"
                            <?php selected(isset($_GET['orderby']) ? $_GET['orderby'] : '', 'popularity'); ?>>
                            <?php _e('Sort by popularity', 'canhcamtheme'); ?></option>
                        <option value="rating"
                            <?php selected(isset($_GET['orderby']) ? $_GET['orderby'] : '', 'rating'); ?>>
                            <?php _e('Sort by average rating', 'canhcamtheme'); ?></option>
                        <option value="date"
                            <?php selected(isset($_GET['orderby']) ? $_GET['orderby'] : '', 'date'); ?>>
                            <?php _e('Sort by latest', 'canhcamtheme'); ?></option>
                        <option value="price"
                            <?php selected(isset($_GET['orderby']) ? $_GET['orderby'] : '', 'price'); ?>>
                            <?php _e('Sort by price: low to high', 'canhcamtheme'); ?></option>
                        <option value="price-desc"
                            <?php selected(isset($_GET['orderby']) ? $_GET['orderby'] : '', 'price-desc'); ?>>
                            <?php _e('Sort by price: high to low', 'canhcamtheme'); ?></option>
                    </select>
                    <?php 
                            // Preserve existing query parameters
                            if (isset($_GET['s'])) {
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="item-product">
                        <div class="product-stock-quantity mb-3">
                            <div class="stock"><?php echo $product->is_in_stock() ? 'In stock' : 'Out of stock'; ?>
                            </div>
                        ...
                        <div class="product-img mb-5">
                            <div class="img-ratio ratio:pt-[158_280] ratio-contain rounded-3">
                                ...
                                <img class="lozad undefined" data-src="<?php echo get_the_post_thumbnail_url(); ?>"
                                    alt="<?php the_title(); ?>" />
                                <?php else : ?>
                                <img class="lozad undefined" data-src="<?php echo wc_placeholder_img_src(); ?>"
                                    alt="<?php the_title(); ?>" />
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="product-wrap-title mb-5">
                            ...
                            <div class="product-desc">
                                <?php echo wp_trim_words($product->get_short_description(), 10); ?></div>
                        </div>
                        <div class="product-price flex flex-col gap-1 mb-5">
                            <p class="unit"><?php _e('Unit Price:', 'canhcamtheme'); ?>
                                <strong><?php echo $product->get_price_html(); ?></strong></p>
                            <p class="total"><?php _e('Total:', 'canhcamtheme'); ?> <strong
                                    class="product-total-price"><?php echo $product->get_price_html(); ?></strong></p>
                        </div>
                        <div class="product-buttons flex lg:gap-6 gap-base">
                            ...
                            <a class="btn btn-primary flex-1 add-to-cart-btn"
    ...
    <div id="add-to-cart-modal" class="modal-overlay" style="display: none;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="popup-cart-form">
                    <div class="form-group">
                        <label for="popup_user_id"><?php _e('User ID', 'canhcamtheme'); ?> <span class="required"
                                style="color: red;">*</span></label>
                        <input type="text" id="popup_user_id" name="user_id" required placeholder="Enter your User ID">
                        <span class="error-message" style="color: #e74c3c; font-size: 12px; display: none;"></span>
                    </div>
                    <div class="form-group">
                        <label for="popup_ingame_name"><?php _e('Ingame Name / Notes', 'canhcamtheme'); ?> <span
            ...
            <div class="modal-footer">
                <button type="button"
                    class="btn btn-secondary modal-cancel"><?php _e('Cancel', 'canhcamtheme'); ?></button>
                <button type="button"
                    class="btn btn-primary modal-add-to-cart"><?php _e('Add to Cart', 'canhcamtheme'); ?></button>
            </div>
        </div>
    </div>
    ...
    <div class="container text-white">
        ...
        <div class="flex flex-col gap-base">
            ...
            <div class="item-row-content grid md:grid-cols-2 gap-base">
                <div class="col-img"><a class="img img-ratio ratio:pt-[382_680] rounded-4"><img class="lozad undefined"
                            data-src="<?php echo $content['image']['url']; ?>"
                            alt="<?php echo $content['image']['alt']; ?>" /></a></div>
